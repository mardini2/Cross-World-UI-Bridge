r"""
UI Bridge CLI (fixed):
- Automatically includes X-UIB-Token from env UIB_TOKEN or %LOCALAPPDATA%\UIBridge\token.txt
- doctor / open / search / browser commands
- token subcommands: show, write
"""
