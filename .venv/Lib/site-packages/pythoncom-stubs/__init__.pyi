...
def CoCreateFreeThreadedMarshaler(
...
def CoCreateInstance(
    __clsid: _win32typing.PyIID,
    __unkOuter: _win32typing.PyIUnknown | None,
    __context: int,
    __iid: _win32typing.PyIID,
) -> _win32typing.PyIUnknown: ...
...
def CoTreatAsClass(
    clsidold: _win32typing.PyIID, clsidnew: _win32typing.PyIID
) -> None: ...
...
def CreatePointerMoniker(
    IUnknown: _win32typing.PyIUnknown,
) -> _win32typing.PyIMoniker: ...
def CreateTypeLib(): ...
def CreateTypeLib2(): ...
...
def ObjectFromLresult(
    lresult, iid: _win32typing.PyIID, wparm
) -> _win32typing.PyIUnknown: ...
...
def WriteClassStg(
    storage: _win32typing.PyIStorage, iid: _win32typing.PyIID
) -> None: ...
