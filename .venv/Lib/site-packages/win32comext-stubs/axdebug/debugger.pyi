...
from win32com.axdebug import contexts as contexts
from win32com.axdebug import documents
from win32com.axdebug import gateways as gateways
...
def BuildModule(
    module, built_nodes, rootNode, create_node_fn, create_node_args
) -> None: ...
...
class AXDebugger:
    ...
    def __init__(
        self,
        interfaceMaker: Incomplete | None = ...,
        processName: Incomplete | None = ...,
    ) -> None: ...
    def Break(self) -> None: ...
    app: Incomplete
    root: Incomplete
