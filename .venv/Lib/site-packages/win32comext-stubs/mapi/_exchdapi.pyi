...
def HrCreateDirEntryIdEx(
    addrBook: _win32typing.PyIAddrBook, distinguishedName: str
) -> str: ...
...
def HrMAPIFindFolderEx(
    msgStore: _win32typing.PyIMsgStore, sepString: str, path: str
) -> str: ...
def HrMAPIFindIPMSubtree(msgStore: _win32typing.PyIMsgStore) -> str: ...
def HrMAPIFindInbox(msgStore: _win32typing.PyIMsgStore) -> str: ...
def HrMAPIFindStore(
    session: _win32typing.PyIMAPISession, name: str
) -> _win32typing.PyIMsgStore: ...
def HrMAPIFindSubfolderEx(
    rootFolder: _win32typing.PyIMAPIFolder, sep: str, name: str
) -> _win32typing.PyIMsgStore: ...
def HrMAPIOpenFolderEx(
    msgStore: _win32typing.PyIMsgStore, sep: str, name: str
) -> _win32typing.PyIMAPIFolder: ...
...
def HrMailboxLogon(
    session: _win32typing.PyIMAPISession,
    msgStore: _win32typing.PyIMsgStore,
    msgStoreDN: str,
    mailboxDN: str,
) -> _win32typing.PyIMsgStore: ...
def HrOpenExchangePrivateStore(
    session: _win32typing.PyIMAPISession,
) -> _win32typing.PyIMsgStore: ...
def HrOpenExchangePublicFolders(
    store: _win32typing.PyIMsgStore,
) -> _win32typing.PyIMAPIFolder: ...
def HrOpenExchangePublicStore(
    session: _win32typing.PyIMAPISession,
) -> _win32typing.PyIMsgStore: ...
def HrOpenSessionObject(
    session: _win32typing.PyIMAPISession,
) -> _win32typing.PyIMAPIProp: ...
def HrOpenSiteContainer(
    session: _win32typing.PyIMAPISession,
) -> _win32typing.PyIMAPIProp: ...
def HrOpenSiteContainerAddressing(
    session: _win32typing.PyIMAPISession,
) -> _win32typing.PyIMAPIProp: ...
