...
def CreateDialog(
    idRes, dll: _win32typing.PyDLL | None = ...
...
def CreateFormView(
    doc: _win32typing.PyCDocument, Template
...
def CreatePropertySheet(
    caption: _win32typing.PyResourceId,
    parent: _win32typing.PyCWnd | None = ...,
    select=...,
...
def CreateStatusBar(
    parent: _win32typing.PyCWnd, arg, arg1, ctrlStype=...
...
def CreateToolBar(
    parent: _win32typing.PyCWnd, style, arg
...
def RegisterWndClass(
    style, hCursor: int = ..., hBrush: int = ..., hIcon=...
) -> str: ...
