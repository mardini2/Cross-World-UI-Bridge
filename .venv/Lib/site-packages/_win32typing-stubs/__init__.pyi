...
class PyACL:
    ...
    def AddAccessAllowedAce(
        self, __revision: int, __access: int, __sid: PySID
    ) -> None: ...
    ...
    def GetEffectiveRightsFromAcl(
        self, __trustee: PyTRUSTEE | dict[str, int | PySID]
    ) -> int: ...
    def GetAuditedPermissionsFromAcl(
        self, trustee: PyTRUSTEE
    ) -> tuple[Incomplete, Incomplete]: ...
    def SetEntriesInAcl(
        self, __obexpl_list: tuple[dict[str, int | dict[str, int | PySID]], ...]
    ) -> PyACL: ...
...
class PyCERT_CONTEXT:
    ...
    def CertSetCertificateContextProperty(
        self, PropId, Data, Flags: int = ...
    ) -> None: ...
...
class PyCRYPTKEY:
    ...
    def CryptDuplicateKey(
        self, Reserved: int = ..., Flags: int = ...
    ) -> PyCRYPTKEY: ...
    def CryptEncrypt(
        self, Final, Data, Hash: PyCRYPTHASH | None = ..., Flags: int = ...
    ): ...
    def CryptDecrypt(
        self, Final, Data, Hash: PyCRYPTHASH | None = ..., Flags: int = ...
    ): ...
...
class PyCRYPTPROV:
    ...
    def CryptExportPublicKeyInfo(
        self, KeySpec, CertEncodingType
...
class PyCTL_CONTEXT:
    ...
    def CertEnumSubjectInSortedCTL(
        self,
    ) -> tuple[tuple[Incomplete, Incomplete], ...]: ...
...
class PyConsoleScreenBuffer:
    ...
    def ReadConsoleOutputAttribute(
        self, Length, ReadCoord: PyCOORD
    ) -> tuple[Incomplete, ...]: ...
    ...
    def GetCurrentConsoleFont(
        self, MaximumWindow: bool = ...
    ) -> tuple[Incomplete, PyCOORD]: ...
    def GetConsoleFontSize(self, Font) -> PyCOORD: ...
    def SetConsoleFont(self, Font) -> None: ...
    def SetStdHandle(self, StdHandle) -> None: ...
    def SetConsoleDisplayMode(
        self, Flags, NewScreenBufferDimensions: PyCOORD
    ) -> None: ...
...
class PySECURITY_DESCRIPTOR:
    ...
    def SetSecurityDescriptorOwner(
        self, __sid: PySID, __bOwnerDefaulted: int | bool
    ) -> None: ...
    def SetSecurityDescriptorGroup(self, sid: PySID, bOwnerDefaulted): ...
    def SetSecurityDescriptorDacl(
        self, __bSaclPresent: int | bool, __SACL: PyACL, __bSaclDefaulted: int | bool
    ) -> None: ...
    def SetSecurityDescriptorSacl(
        self, bSaclPresent, SACL: PyACL, bSaclDefaulted
    ) -> None: ...
    def SetSecurityDescriptorControl(
        self, ControlBitsOfInterest, ControlBitsToSet
    ) -> None: ...
    def IsValid(self) -> bool: ...
...
class Pymmapfile:
    ...
    def read_line(self): ...
    def resize(
        self, MaximumSize, FileOffset: int = ..., NumberOfBytesToMap: int = ...
    ) -> None: ...
...
class PyGSecurityInformation:
    ...
    def GetAccessRights(
        self, ObjectType: PyIID, Flags
    ) -> tuple[SI_ACCESS, Incomplete]: ...
...
class PyIActiveScriptDebug:
    ...
    def GetScriptletTextAttributes(
        self, pstrCode: str, pstrDelimiter: str, dwFlags
    ) -> None: ...
...
class PyIApplicationDebugger:
    ...
    def onHandleBreakPoint(
        self, prpt: PyIRemoteDebugApplicationThread, br, pError
    ) -> None: ...
...
class PyIApplicationDocumentlists:
    def SetAppID(self, AppID) -> None: ...
    def Getlist(
        self, listType, riid: PyIID, ItemsDesired: int = ...
    ) -> PyIEnumObjects: ...
...
class PyIContextMenu:
    def QueryContextMenu(
        self, hmenu: int, indexMenu, idCmdFirst, idCmdLast, uFlags
    ): ...
...
class PyICreateTypeInfo:
    ...
    def SetFuncAndParamNames(
        self, index, rgszNames: tuple[Incomplete, ...]
    ) -> None: ...
...
class PyIDataObject:
    ...
    def SetData(
        self, pformatetc: PyFORMATETC, pmedium: PySTGMEDIUM, fRelease
    ) -> None: ...
...
class PyIDebugApplication:
    ...
    def SynchronousCallInDebuggerThread(
        self, pptc, dwParam1, dwParam2, dwParam3
    ) -> None: ...
...
class PyIDebugApplicationThread:
    def SynchronousCallIntoThread(
        self, pstcb, dwParam1, dwParam2, dwParam3
    ) -> None: ...
...
class PyIDebugDocumentHelper:
    def Init(
        self, pda: PyIDebugApplication, pszShortName, pszLongName, docAttr
    ) -> None: ...
...
class PyIDirectoryObject:
    ...
    def CreateDSObject(
        self, rdn: str, attrs: tuple[PyADS_ATTR_INFO, ...]
    ) -> PyIDispatch: ...
    def DeleteDSObject(self, rdn: str) -> None: ...

class PyIDirectorySearch:
    def SetSearchPreference(
        self, prefs
...
class PyIDispatch:
    def Invoke(
        self, dispid, lcid, flags, bResultWanted, arg: tuple[Incomplete, ...]
    ): ...
    def InvokeTypes(
        self,
        dispid,
...
class PyIDropTargetHelper:
    ...
    def DragOver(
        self, hwnd: int, pt: tuple[Incomplete, Incomplete], pdwEffect
    ) -> None: ...
    def DragLeave(self) -> None: ...
    def Drop(
...
class PyIEmptyVolumeCacheCallBack:
    ...
    def PurgeProgress(
        self, dwlSpaceFreed, spaceFreed, spaceToFree, flags, status
    ) -> None: ...
...
class PyIEnumContextProps:
    def Next(
        self, num: int = ...
    ) -> tuple[tuple[PyIID, Incomplete, PyIUnknown], ...]: ...
    def Skip(self) -> None: ...
    def Reset(self) -> None: ...
...
class PyIInternetProtocolInfo:
    def ParseUrl(
        self, pwzUrl, ParseAction, dwParseFlags, cchResult, dwReserved
    ) -> None: ...
    def CombineUrl(
...
class PyILockBytes:
    ...
    def LockRegion(
        self, libOffset: ULARGE_INTEGER, cb: ULARGE_INTEGER, dwLockType
    ) -> None: ...
    def UnlockRegion(
        self, libOffset: ULARGE_INTEGER, cb: ULARGE_INTEGER, dwLockType
    ) -> None: ...
...
class PyIMAPIProp:
    ...
    def OpenProperty(
        self, propTag, iid: PyIID, interfaceOptions, flags
    ) -> PyIUnknown: ...
    def GetIDsFromNames(
...
class PyIMachineDebugManagerEvents:
    ...
    def onRemoveApplication(
        self, pda: PyIRemoteDebugApplication, dwAppCookie
    ) -> None: ...
...
class PyINameSpaceTreeControl:
    def Initialize(
        self,
        hwndParent,
        prc: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
        nsctsFlags,
    ) -> None: ...
    def TreeAdvise(self, punk: PyIUnknown) -> None: ...
    def TreeUnadvise(self, dwCookie) -> None: ...
    def AppendRoot(
        self, psiRoot: PyIShellItem, grfEnumFlags, grfRootStyle, pif
    ) -> None: ...
    def InsertRoot(
...
class PyIOleInPlaceUIWindow:
    ...
    def SetActiveObject(
        self, pActiveObject: PyIOleInPlaceActiveObject, pszObjName
    ) -> None: ...
...
class PyIOleObject:
    ...
    def GetMoniker(self, dwAssign, dwWhichMoniker) -> None: ...
    def InitFromData(
        self, pDataObject: PyIDataObject, fCreation, dwReserved
    ) -> None: ...
...
class PyIPropertyStoreCache:
    ...
    def GetValueAndState(
        self, key: PyPROPERTYKEY
    ) -> tuple[PyPROPVARIANT, Incomplete]: ...
    def SetState(self, key: PyPROPERTYKEY, state) -> None: ...
    def SetValueAndState(
        self, key: PyPROPERTYKEY, value: PyPROPVARIANT, state
    ) -> None: ...
...
class PyIScheduledWorkItem:
    ...
    def GetRunTimes(
        self, Count, Begin: PyTime, End: PyTime
    ) -> tuple[PyTime, Incomplete, Incomplete, Incomplete]: ...
...
class PyIShellBrowser:
    ...
    def SetMenuSB(
        self, hmenuShared: int, holemenuRes: int, hwndActiveObject: int
    ) -> None: ...
...
class PyIShellExtInit:
    def Initialize(
        self, pFolder: PyIDL, pDataObject: PyIDataObject, hkey: int
    ) -> None: ...
...
class PyIShellFolder:
    ...
    def BindToObject(
        self, pidl: PyIDL, pbc: PyIBindCtx, riid: PyIID
    ) -> PyIShellFolder: ...
...
class PyIShellItemResources:
    ...
    def SetTimes(
        self, pftCreation: PyTime, pftWrite: PyTime, pftAccess: PyTime
    ) -> None: ...
...
class PyIShellLibrary:
    ...
    def Commit(self) -> None: ...
    def Save(
        self, FolderToSaveIn: PyIShellItem, LibraryName, Flags
    ) -> PyIShellItem: ...
    def SaveInKnownFolder(
        self, FolderToSaveIn: PyIID, LibraryName, Flags
    ) -> PyIShellItem: ...
...
class PyIStorage:
    ...
    def CopyTo(
        self,
        rgiidExclude: tuple[Incomplete, Incomplete],
        snbExclude,
        stgDest: PyIStorage,
    ) -> None: ...
...
class PyIStream:
    ...
    def Revert(self) -> None: ...
    def LockRegion(
        self, offset: ULARGE_INTEGER, cb: ULARGE_INTEGER, lockType
    ) -> None: ...
    def UnLockRegion(
        self, offset: ULARGE_INTEGER, cb: ULARGE_INTEGER, lockType
    ) -> None: ...
...
class PyITransferAdviseSink:
    ...
    def ConfirmOverwrite(
        self, Source: PyIShellItem, DestParent: PyIShellItem, Name
    ): ...
...
class PyITransferSource:
    ...
    def GetDefaultDestinationName(
        self, Source: PyIShellItem, ParentDest: PyIShellItem
    ): ...
...
class PyCDC:
    ...
    def DrawText(
        self,
        s: str,
        _tuple: tuple[Incomplete, Incomplete, Incomplete, Incomplete],
        _format,
    ) -> tuple[Incomplete, Incomplete, Incomplete]: ...
    def Ellipse(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete]
...
class PyCDialogBar:
    def CreateWindow(
        self, parent: PyCWnd, template: PyResourceId, style, _id
    ) -> None: ...
...
class PyCDockContext:
    ...
    @property
    def rectFrameDragHorz(
        self,
    ) -> tuple[Incomplete, Incomplete, Incomplete, Incomplete]: ...
    @property
    def rectFrameDragVert(
        self,
    ) -> tuple[Incomplete, Incomplete, Incomplete, Incomplete]: ...
    @property
    def dwDockStyle(self): ...
...
class PyCDocument:
    ...
    def UpdateAllViews(
        self, sender: PyCView, hint: Incomplete | None = ...
    ) -> None: ...
...
class PyCMenu:
    ...
    def ModifyMenu(
        self, pos, flags, _id: int = ..., value: str | None = ...
    ) -> None: ...
    def TrackPopupMenu(
        self, arg: tuple[Incomplete, Incomplete], arg1, arg2: PyCWnd
    ) -> None: ...
...
class PyCSliderCtrl:
    ...
    def GetRange(self): ...
    def SetRange(
        self, nRangeMin: int = ..., nRangeMax: int = ..., bRedraw: int = ...
    ): ...
...
class PyCToolBarCtrl:
    ...
    def SetBitmapSize(
        self, width1, height1, width: int = ..., height: int = ...
    ) -> None: ...
    def SetButtonSize(
        self, width1, height1, width: int = ..., height: int = ...
    ) -> None: ...
...
class PyCView:
    ...
    def GetDocument(self) -> PyCDocument: ...
    def OnActivateView(
        self, activate, activateView: PyCView, DeactivateView: PyCView
    ): ...
...
class PyCWnd:
    ...
    def SendMessage(
        self, idMessage, idMessage1, ob, wParam: int = ..., lParam: int = ...
    ) -> None: ...
    ...
    def ScreenToClient(
        self,
        rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete, Incomplete],
        pnt,
    ) -> tuple[Incomplete, Incomplete, Incomplete, Incomplete, Incomplete]: ...
...
class EXTENSION_CONTROL_BLOCK:
    ...
    def SendResponseHeaders(
        self, reply: str, headers: str, keepAlive: bool = ...
    ) -> None: ...
    ...
    def ExecURL(
        self, url: str, method: str, clientHeaders: str, info, entity, flags
    ): ...
