...
def format_binaries_and_datas(binaries_or_datas, workingdir=None):
    ...
    for src_root_path_or_glob, trg_root_dir in binaries_or_datas:
        ...
        if os.path.isfile(src_root_path_or_glob) or os.path.isdir(
                ...
                for src_dir, src_subdir_basenames, src_file_basenames in os.walk(
                    ...
                    if was_glob:
                        ...
                        rel_dir = os.path.relpath(
                            src_dir, os.path.dirname(src_root_path)
                        )
                    else:
...
def _should_include_system_binary(binary_tuple, exceptions):
    ...
    dest = binary_tuple[0]
    if dest.startswith(
        f"python{sys.version_info.major}.{sys.version_info.minor}/lib-dynload"
    ):
        return True
    src = binary_tuple[1]
