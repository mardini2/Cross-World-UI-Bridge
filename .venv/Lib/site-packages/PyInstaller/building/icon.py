...
def normalize_icon_type(
    icon_path: str, allowed_types: Tuple[str], convert_type: str, workpath: str
) -> str:
    """
    ...
    try:
        _generated_name = (
            f"generated-{hashlib.sha256(icon_path.encode()).hexdigest()}.{convert_type}"
        )
