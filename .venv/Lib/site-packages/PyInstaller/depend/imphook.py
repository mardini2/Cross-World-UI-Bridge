...
class ModuleHookCache(dict):
    ...
    def _cache_hook_dirs(self, hook_dirs):
        ...
        for module_name in self.keys():
            ...
            if len(hooks) == 1:
                ...
                sorted_hooks = sorted(
                    hooks, key=lambda hook: hook.priority, reverse=True
                )
    ...
    def remove_modules(self, *module_names):
        ...
        for module_name in module_names:
            ...
            # collect them.
            module_hook = self.pop(
                module_name, None
            )  # Remove our reference, if available.
...
class ModuleHook:
    ...
    def _load_hook_metadata(self):
        ...
        priority_pattern = re.compile(
            r"^\s*#\s*\$PyInstaller-Hook-Priority:\s*(?P<value>[\S]+)"
        )
    ...
    def _process_hook_func(self, analysis):
        ...
        self.bindepend_symlink_suppression.update(
            hook_api._bindepend_symlink_suppression
        )
