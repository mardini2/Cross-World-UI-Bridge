...
HOOK_PRIORITY_UPSTREAM_HOOKS = (
    0  # Hooks provided by packages themselves, via entry-points.
)
HOOK_PRIORITY_USER_HOOKS = (
    1000  # User-supplied hooks (command-line / spec file). Highest priority.
)
...
class PyiModuleGraph(ModuleGraph):
    ...
    def _find_module_path(self, fullname, module_name, search_dirs):
        ...
        if hook is not None:
            ...
            hook_fullname = (
                "PyInstaller_hooks_pre_find_module_path_" + fullname.replace(".", "_")
            )
