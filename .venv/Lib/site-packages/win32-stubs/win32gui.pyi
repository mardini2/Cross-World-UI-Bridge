...
def ResetDC(
    __hdc: int, __devmode: _win32typing.PyDEVMODE | _win32typing.PyDEVMODEW
) -> int: ...
...
def EnumThreadWindows(
    dwThreadId, __callback: Callable[[int, _T], object], __extra: _T
) -> None: ...
def EnumChildWindows(
    __hwnd: int | None, __callback: Callable[[int, _T], object], __extra: _T
) -> None: ...
def DialogBox(
    hInstance: int,
...
def CreateAcceleratorTable(
    accels: tuple[tuple[Incomplete, Incomplete, Incomplete], ...]
): ...
...
def LoadIcon(
    __hinstance: int, __resource_id_or_name: str | int
) -> _win32typing.PyWNDCLASS: ...
def CopyIcon(hicon): ...
...
def FindWindow(
    __ClassName: _win32typing.PyResourceId | str | None, __WindowName: str | None
) -> int: ...
def FindWindowEx(
    __Parent: int | None,
...
def CreateBitmap(
    width, height, cPlanes, cBitsPerPixel, bitmap_bits
) -> _win32typing.PyGdiHANDLE: ...
...
def MoveWindow(
    __hwnd: int, __x: int, __y: int, __width: int, __height: int, __bRepaint: bool
) -> None: ...
...
def CreatePopupMenu(): ...
def TrackPopupMenu(
    hmenu, flags, x, y, reserved, hwnd: int, prcRect: _win32typing.PyRECT
): ...
...
def RedrawWindow(
    ...
    hrgnUpdate: _win32typing.PyGdiHANDLE,
    flags,
) -> None: ...
...
def GradientFill(
    hdc, Vertex: tuple[_win32typing.PyTRIVERTEX, ...], Mesh, Mode
) -> None: ...
...
def FillRect(
    hDC: int, rc: _win32typing.PyRECT, hbr: _win32typing.PyGdiHANDLE
) -> None: ...
def FillRgn(
    hdc: int, hrgn: _win32typing.PyGdiHANDLE, hbr: _win32typing.PyGdiHANDLE
) -> None: ...
...
def RoundRect(
    hdc: int, LeftRect, TopRect, RightRect, BottomRect, Width, Height
) -> None: ...
...
def CreateCaret(
    hWnd: int, hBitmap: _win32typing.PyGdiHANDLE, nWidth, nHeight
) -> None: ...
...
def SystemParametersInfo(
    Action, Param: Incomplete | None = ..., WinIni: int = ...
) -> None: ...
def SetLayeredWindowAttributes(hwnd: int, Key, Alpha, Flags) -> None: ...
def GetLayeredWindowAttributes(
    hwnd: int,
) -> tuple[Incomplete, Incomplete, Incomplete]: ...
...
def ExtCreatePen(
    PenStyle,
    Width,
    lb: _win32typing.PyLOGBRUSH,
    Style: tuple[Incomplete, ...] | None = ...,
) -> int: ...
def DrawTextW(
...
def RegisterDeviceNotification(
    handle: int, _filter, flags
) -> _win32typing.PyHDEVNOTIFY: ...
