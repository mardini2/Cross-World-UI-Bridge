...
def SetPrinter(
    hPrinter: _win32typing.PyPrinterHANDLE, Level, pPrinter, Command
) -> None: ...
...
def StartDocPrinter(
    hprinter: _win32typing.PyPrinterHANDLE, _tuple, level: int = ...
): ...
...
def EnumPrintProcessorDatatypes(
    ServerName: str, PrintProcessorName: str
) -> tuple[str, ...]: ...
