...
def DsCrackNames(
    hds: _win32typing.PyDS_HANDLE,
    flags,
    formatOffered,
    formatDesired,
    names: list[Incomplete],
...
def LookupAccountName(
    __systemName: str | None, __accountName: str
) -> tuple[_win32typing.PySID, str, int]: ...
def LookupAccountSid(
    __systemName: str, __sid: _win32typing.PySID
...
def GetNamedSecurityInfo(
    __ObjectName: str, __ObjectType: int, __SecurityInfo: int
) -> _win32typing.PySECURITY_DESCRIPTOR: ...
def OpenProcessToken(processHandle, desiredAccess) -> int: ...
def LookupPrivilegeValue(
    systemName: str, privilegeName: str
) -> _win32typing.LARGE_INTEGER: ...
...
def GetFileSecurity(
    __filename: str, __info: int = ...
) -> _win32typing.PySECURITY_DESCRIPTOR: ...
def SetFileSecurity(
    __filename: str, __info: int, __security: _win32typing.PySECURITY_DESCRIPTOR
) -> None: ...
...
def SetTokenInformation(
    TokenHandle: int, TokenInformationClass, TokenInformation
) -> None: ...
...
def LsaRetrievePrivateData(
    PolicyHandle: _win32typing.PyLSA_HANDLE, KeyName: str
) -> str: ...
...
def LsaRegisterLogonProcess(
    LogonProcessName: str,
) -> _win32typing.PyLsaLogon_HANDLE: ...
