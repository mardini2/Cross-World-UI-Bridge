...
def OpenEventLog(
    __serverName: str | None, __sourceName: str
) -> _win32typing.PyEVTLOG_HANDLE: ...
def RegisterEventSource(__serverName: str | None, __sourceName: str): ...
def OpenBackupEventLog(
    serverName: str, fileName: str
) -> _win32typing.PyEVTLOG_HANDLE: ...
def ReportEvent(
    __EventLog: int,
    __Type: int,
...
def EvtQuery(
    ...
    __Flags: int,
    __Query: str | None = ...,
    __Session: _win32typing.PyEVT_HANDLE | None = ...,
) -> _win32typing.PyEVT_HANDLE: ...
def EvtNext(
    __ResultSet: _win32typing.PyEVT_HANDLE,
    __Count: int,
    __Timeout: int = ...,
    __Flags: int = ...,
...
def EvtGetLogInfo(
    Log: _win32typing.PyEVT_HANDLE, PropertyId
) -> tuple[Incomplete, Incomplete]: ...
def EvtGetEventInfo(
