...
def EnumServicesStatus(
    hSCManager: _win32typing.PySC_HANDLE, ServiceType, ServiceState
) -> tuple[Incomplete, ...]: ...
...
def StartService(
    hService: _win32typing.PySC_HANDLE, args: Iterable[str] | None
) -> None: ...
def OpenService(
...
def SetServiceStatus(
    scHandle,
    serviceStatus: (
        _win32typing.SERVICE_STATUS | tuple[int, int, int, int, int, int, int]
    ),
) -> None: ...
def ControlService(
    scHandle: _win32typing.PySC_HANDLE, code
) -> _win32typing.SERVICE_STATUS: ...
...
def ChangeServiceConfig2(
    hService: _win32typing.PySC_HANDLE, InfoLevel, info
) -> None: ...
