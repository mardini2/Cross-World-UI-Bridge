...
def ChangeDisplaySettingsEx(
    DeviceName: Incomplete | None = ...,
    DevMode: _win32typing.PyDEVMODE | None = ...,
    Flags=...,
): ...
...
def EnumDisplayMonitors(
    ...
    tuple[_win32typing.PyHANDLE, _win32typing.PyHANDLE, tuple[int, int, int, int]]
]: ...
def EnumDisplaySettings(
    DeviceName: str | None = ..., ModeNum: int = ...
) -> _win32typing.PyDEVMODEW: ...
def EnumDisplaySettingsEx(
    ModeNum, DeviceName: str | None = ..., Flags=...
) -> _win32typing.PyDEVMODEW: ...
...
def EnumResourceNames(
    hmodule: int, resType: _win32typing.PyResourceId
) -> list[str]: ...
...
def GetProfileVal(
    section: str, entry: str, defValue: str, iniName: str | None = ...
) -> str: ...
...
def LoadResource(
    handle: int,
    _type: _win32typing.PyResourceId,
    name: _win32typing.PyResourceId,
    language,
) -> str: ...
...
def MonitorFromRect(
    __rc: _win32typing.PyRECT | tuple[int, int, int, int], __Flags: int = ...
) -> int: ...
...
def PostMessage(
    hwnd: int,
    idMessage,
    wParam: Incomplete | None = ...,
    lParam: Incomplete | None = ...,
) -> None: ...
...
def RegCopyTree(
    KeySrc: _win32typing.PyHKEY, SubKey: str, KeyDest: _win32typing.PyHKEY
) -> None: ...
def RegCreateKey(
    key: _win32typing.PyHKEY | int, subKey: str
) -> _win32typing.PyHKEY: ...
def RegCreateKeyEx(
...
def RegEnumValue(
    key: _win32typing.PyHKEY, index
) -> tuple[str, Incomplete, Incomplete]: ...
...
def RegOpenKey(
    __key: _win32typing.PyHKEY | int,
    __subkey: str | None,
    __reserved: bool = ...,
    __sam: int = ...,
) -> _win32typing.PyHKEY: ...
def RegOpenKeyEx(
    __key: _win32typing.PyHKEY, __subKey: str, __sam: int, __reserved: bool = ...
) -> _win32typing.PyHKEY: ...
...
def RegOverridePredefKey(
    Key: _win32typing.PyHKEY, NewKey: _win32typing.PyHKEY
) -> None: ...
def RegQueryValue(key: _win32typing.PyHKEY, subKey: str) -> str: ...
def RegQueryValueEx(
    __key: _win32typing.PyHKEY | int, __valueName: str | None
) -> tuple[str, int]: ...
def RegQueryInfoKey(
    key: _win32typing.PyHKEY,
...
def RegSetValue(
    key: _win32typing.PyHKEY, subKey: str | None, _type, value: str
) -> None: ...
def RegSetValueEx(
    key: _win32typing.PyHKEY, valueName: str, reserved, _type, value
) -> None: ...
...
def SetConsoleCtrlHandler(
    __ctrlHandler: Callable[[int], bool], __bAdd: bool
) -> None: ...
...
def WriteProfileVal(
    section: str, entry: str, value: str, iniName: str | None = ...
) -> None: ...
