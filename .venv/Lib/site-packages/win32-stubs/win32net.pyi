...
def NetMessageBufferSend(
    domain: str, userName: str, fromName: str, message: str
) -> None: ...
...
def NetUserGetGroups(
    serverName: str, userName: str
) -> list[tuple[Incomplete, Incomplete]]: ...
def NetUserGetInfo(server: str, username: str, level): ...
def NetUserGetLocalGroups(
    serverName: str, userName: str, flags
) -> list[Incomplete]: ...
...
def NetSessionDel(
    server: str, client: str | None = ..., username: str | None = ...
) -> None: ...
