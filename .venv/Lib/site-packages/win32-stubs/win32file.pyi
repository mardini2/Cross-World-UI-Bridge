...
def CreateIoCompletionPort(
    handle: int, existing: int, completionKey, numThreads
) -> int: ...
def CreateMailslot(
    Name,
    MaxMessageSize,
...
def GetFileTime(
    handle: int,
    creationTime: _win32typing.PyTime,
    accessTime: _win32typing.PyTime,
    writeTime: _win32typing.PyTime,
...
def ReadFile(
    __hFile: int,
    __buffer: _win32typing.PyOVERLAPPEDReadBuffer,
    __overlapped: _win32typing.PyOVERLAPPED | None,
) -> tuple[int, str]: ...
def WriteFile(
    __hFile: int,
    __data: str | bytes | _win32typing.PyOVERLAPPEDReadBuffer,
    __ol: _win32typing.PyOVERLAPPED | None = ...,
) -> tuple[int, int]: ...
...
def GetOverlappedResult(
    __hFile: int, __overlapped: _win32typing.PyOVERLAPPED, __bWait: int | bool
) -> int: ...
def LockFile(
...
def SetFileAttributesW(
    FileName, FileAttributes, Transaction: int | None = ...
) -> None: ...
...
def SetFileInformationByHandle(
    File: int, FileInformationClass, Information
) -> None: ...
